...
const ModalPayment = () => {
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div
        className={`fixed top-40 left-1/2 z-999 h-auto w-[80%] -translate-x-1/2 rounded-xl bg-white px-5 pb-6 transition-all duration-500 ease-in-out ${showModal ? "translate-y-0" : "translate-y-4"}`}
      >
        ...
        <div>
          <button
            onClick={() => setShowModal(false)}
            className="mt-6 w-full rounded-lg bg-green-600 py-2 font-bold text-white hover:bg-green-700"
          >
            OK
          </button>
        </div>
